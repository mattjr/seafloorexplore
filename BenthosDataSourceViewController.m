//
//  BenthosDataSourceViewController.m
//  Molecules
//
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	switch (index)
	{
		...
		case 1: 
		{
			...
			BenthosCustomDownloadViewController *customURLViewController = [[BenthosCustomDownloadViewController alloc] initWithNibName:nil bundle:nil];
