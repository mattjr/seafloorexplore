...
{
	return [NSString stringWithFormat:@"<%@ 0x%08lx>\n position: %f %f %f\n rotation: %f %f %f \n children:%@", [self class], (long int)self, position[0], position[1], position[2], rotation[0], rotation[1], rotation[2], [children description]];
}
